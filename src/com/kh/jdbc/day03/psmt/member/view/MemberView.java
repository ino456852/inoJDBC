package com.kh.jdbc.day03.psmt.member.view;

import java.util.Scanner;

import com.kh.jdbc.day03.psmt.member.controller.MemberController;
		...
		while(true) {
			...
			switch(choice) {
				...
				case 4: 
					...
					member = mController.checkMember(memberId);
					if(member != null) {
						result = mController.deleteInfo(memberId);
						if(result > 0) 
							printMsg("삭제 성공");
					} else {
						printMsg("존재하지 않는 정보입니다.");
